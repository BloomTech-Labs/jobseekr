...
class Jobs extends Component {
  ...
  getAllLists = () => {
    ...
    axios
      .get(`${ROOT_URL}/jobslist`, { headers: { Authorization: token } })
      .then(lists => {
        const newList = lists.data;
        this.setState({ lists: newList, _originalLists: newList });
      })
  ...
  onDrop = (e, status) => {
    ...
    axios
      ...
      .catch(err =>
        console.log('error sending updateStatus put to server', err),
      );
  };

  returnOriginalLists = _ => {
    this.setState({ lists: this.state._originalLists });
  };

  updateJobsFromSearch = lists => {
    this.setState({ lists });
  };
        ...
        <Grid className="board__container">
          <Well className="jobs-well">
            ...
            <SearchJobs
              ...
              originalLists={this.state._originalLists}
              returnOriginal={this.returnOriginalLists}
              updateJobs={this.updateJobsFromSearch}
            />
