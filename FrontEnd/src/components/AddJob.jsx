          ...
          if (msg === `Possible duplicate job found`) {
            if (window.confirm(msg + '. Add anyway?')) {
              axios
                ...
                .then(() => {
                  if (this.state.rejectionFile)
                    this.handleFileSubmit('rejectionUrl');
                })
                .then(() => {
                  if (this.state.offerFile) this.handleFileSubmit('offerUrl');
                })
    ...
    return (
      <div className="addJobModal">
        ...
        >
            ...
            <Modal.Body>
              <div className="top-section-job-modal">
                <div className="top-left-section">
                  ...
                  >
                    {statuses
                      .slice(0, Math.ceil(statuses.length / 2))
                      .map(e => {
                        return (
            ...
            <Modal.Body>
              <div className="bottom-section-job-modal">
                ...
                <div className="bottom-right-section">
                  ...
                  />
                  <DropdownButton
                    title={this.state.sourceSelection}
                    id="source-of-job-dropdown"
                  >
          ...
          <Modal.Footer>
            <Button className="confirmAddJob" onClick={this.handleAddJob}>
              Add Job
            </Button>
          </Modal.Footer>
        </Modal>
